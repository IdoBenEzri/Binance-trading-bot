...
-  get_socket_value(coin,interval): 
   ...
   __Finally - after applying your buying/selling algoritms   you can your own  Binance trading bot! I recommend to use the "repair_history" method (under DatabaseManager Class)   from time to time.__
